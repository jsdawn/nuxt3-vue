    ...
    <UContainer class="pt-8">
      ...
      <div class="text-sm text-gray-500 grid grid-cols-1">
        <div class="desc-item pt-6">
          ...
          <p>
            Unsere große Lagerbevorratung an Wälzlagern ermöglicht, dass die Bearbeitung
            Ihres Auftrags und der Versand noch am Tag Ihrer Bestellung erfolgen. Somit
            profitieren Sie bei Kugellager-Express von einer besonders schnellen
            Bestellabwicklung.
          </p>
        </div>
        <div class="desc-item pt-6">
          <h4 class="text-base text-primary">Preiswertigkeit</h4>
          <p>
            Unsere Zusammenarbeit mit internationalen Zulieferern, der globale Einkauf,
            garantiert Ihnen eine gute Kosten-Nutzen-Relation.
          </p>
        </div>
        <div class="desc-item pt-6">
          <h4 class="text-base text-primary">Zuverlässigkeit</h4>
          <p>
            Die ständige unserer Wälzlager gewährleistet Ihnen ein hohes Maß an
            Sicherheit.
          </p>
          <p>
            Uns ist wichtig, dass Sie sowohl mit unseren Produkten als auch mit der
            Kaufabwicklung zufrieden sind.
          </p>
        </div>
      </div>
    </UContainer>
        ...
        <div class="pt-6 sm:flex sm:flex-row-reverse">
          ...
          <div class="desc-item pt-6 sm:basis-1/2">
            ...
            <p>
              ...
              Kugellager-Express GmbH gehörte erneut dazu und belegte dabei im
              Gesamtranking den 301. Platz sowie in der Kategorie „Einzelhandel inkl.
              Versandhandel und E-Commerce“ den 54. Platz.
            </p>
          </div>
        </div>
      </div>
